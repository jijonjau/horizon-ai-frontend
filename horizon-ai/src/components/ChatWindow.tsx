...
const ChatWindow: React.FC<{
  ...
  return (
    <div className="flex flex-col h-auto items-center justify-center w-full">
      <div className="w-full max-w-6xl flex-1 overflow-y-auto space-y-4 p-4 flex flex-col items-center justify-center">
        ...
        {messages.some((msg) => !msg.isUser) && (
          <button
            ...
            className="bg-gray-200 text-[#1B2559] border border-[#E2E8F0] px-3 py-2 rounded-lg font-medium hover:bg-gray-300 transition mt-4 flex items-center"
          >
            <img
      ...
      <div
        className={`${!isAPIKeyFormOpen && messages.length === 0 ? 'md:relative bottom-[-250px]' : ''} w-full max-w-2xl p-4`}
      >
        ...
        <p className="text-[#718096] text-xs mt-2 dark:text-gray-300 text-center">
