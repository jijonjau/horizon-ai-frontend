...
const ScreenModeToggle = () => {
  ...
  return (
    ...
    >
      {darkMode ? (
        <FaSun className="w-4 h-4 text-yellow-400 md:w-5 md:h-5 lg:w-5 lg:h-5 xl:w-5 xl:h-5" />
      ) : (
        <FaMoon className="w-4 h-4 text-gray-700 md:w-5 md:h-5 lg:w-5 lg:h-5 xl:w-5 xl:h-5" />
      )}
    </button>
  );
};
