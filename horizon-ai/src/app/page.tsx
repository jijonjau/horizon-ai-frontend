...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100 dark:bg-gray-900 dark:text-white rounded-lg shadow-md overflow-y-auto">
      <div className="flex flex-row flex-1 h-full">
        ...
        <div
          className={`flex flex-col flex-1 h-full ${isSidebarCollapsed ? 'ml-0' : 'ml-0'}`}
        >
          <Header
            isLoggedIn={isLoggedIn}
            setIsLoggedIn={setIsLoggedIn}
    ...
    //   <div className="flex flex-row flex-1 h-full">
    //     {isSidebarCollapsed && (
    //       <div className="w-64 md:w-72 h-full fixed left-0 top-0 z-50">
    //         <Sidebar
    //           isLoggedIn={isLoggedIn}
    //           setIsLoggedIn={setIsLoggedIn}
    //           isLoginModalOpen={isLoginModalOpen}
    ...
    //     <div className={`flex flex-col flex-1 h-full ${isSidebarCollapsed ? 'ml-58 md:ml-64' : 'ml-0'}`}>
    //       <Header
    //         isLoggedIn={isLoggedIn}
    //         setIsLoggedIn={setIsLoggedIn}
    //         isLoginModalOpen={isLoginModalOpen}
    ...
    //           >
    //             <div className="w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-b from-[#FBFBFF] to-[#CACAFF] border border-[#CACAFF] dark:from-gray-700 dark:to-gray-900 dark:border-gray-600">
    //               <img src="/Icons/auto-awesome.png" alt="gpt-3.5 icon" className="w-4 h-4 object-contain" />
    //             </div>
    //             <span className="whitespace-nowrap">GPT-3.5</span>
    //           </button>
    ...
    //           >
    //             <div className="w-8 h-8 flex items-center justify-center rounded-full border border-[#CACAFF] bg-gradient-to-b from-[#FBFBFF] to-[#CACAFF] dark:from-gray-700 dark:to-gray-900 dark:border-gray-600">
    //               <img src="/Icons/gpt-4.png" alt="gpt-4 icon" className="w-4 h-4 object-contain" />
    //             </div>
    //             <span className="whitespace-nowrap">GPT-4</span>
    //           </button>
    //         </div>
    ...
    //           No plugins enabled{' '}
    //           <span className="ml-2">
    //             <img src="/Icons/plugin-dropdown.png" alt="plugin dropdown icon" />
    //           </span>
    //         </p>

    //         {isAPIKeyFormOpen && <APIKeyForm onClose={() => setIsAPIKeyFormOpen(false)} />}
    //         <ChatWindow isDisabled={isAPIKeyFormOpen} />
    //       </div>
    //       <Footer />
    //     </div>
